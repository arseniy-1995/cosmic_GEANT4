...
//
/// \file ChamberSD.hh
/// \brief Definition of the Cosmic::ChamberSD class

#ifndef CosmicChamberSD_h
#define CosmicChamberSD_h 1
...
class ChamberSD : public G4VSensitiveDetector
{
 ...
 // ChamberSD(const G4String& name, const G4String &hitsCollectionName, DetectorConstruction*);
      ...
      ChamberSD(const G4String &name, const G4String &hitsCollectionName,
