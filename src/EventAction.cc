                ...
                if (index >= 0 && index < N_HCX)
                {
                    ...
                    if (index >= 1)
                    {
                     ...
                     if (index >= 1)
                     {
                         ...
                         fHCX_global_XPos[0][index] = HadronCalorimeter_nsys1Hit_->GetWorldPos().x() / cm;
                         fHCX_global_YPos[0][index] = HadronCalorimeter_nsys1Hit_->GetWorldPos().y() / cm;
                         fHCX_global_ZPos[0][index] = HadronCalorimeter_nsys1Hit_->GetWorldPos().z() / cm;
                    ...
                    fHCX_EdepSum[0][k] += fHCX_Edep[0][index];
                    fHCX_LOSum[0][k] += fHCX_LO[0][index];
                    fHCX_A1Sum[0][k] += fHCX_A1[0][index];
                    fHCX_A2Sum[0][k] += fHCX_A2[0][index];
                    fHCX_T1Sum[0][k] += fHCX_T1[0][index];
                    fHCX_T2Sum[0][k] += fHCX_T2[0][index];
                    fHCX_TrackLengthSum[0][k] += fHCX_TrackLength[0][index];
                    fHCX_ToFSum[0][k] += fHCX_ToF[0][index];

                    fHCX_NSum[0][0]++;
                    fHCX_EdepSum[0][0] += fHCX_Edep[0][index];
                    fHCX_LOSum[0][0] += fHCX_LO[0][index];
                    fHCX_A1Sum[0][0] += fHCX_A1[0][index];
                    fHCX_A2Sum[0][0] += fHCX_A2[0][index];
                    fHCX_T1Sum[0][0] += fHCX_T1[0][index];
                    fHCX_T2Sum[0][0] += fHCX_T2[0][index];
                    fHCX_TrackLengthSum[0][0] += fHCX_TrackLength[0][index];
                    fHCX_ToFSum[0][0] += fHCX_ToF[0][index];
                ...
                if (index >= 0 && index < N_HCZ)
                {
                    ...
                    if (index >= 1)
                    {
                     ...
                     if (index >= 1)
                     {
                         ...
                         fHCZ_global_XPos[0][index] = HadronCalorimeter_nsys1Hit_->GetWorldPos().x() / cm;
                         fHCZ_global_YPos[0][index] = HadronCalorimeter_nsys1Hit_->GetWorldPos().y() / cm;
                         fHCZ_global_ZPos[0][index] = HadronCalorimeter_nsys1Hit_->GetWorldPos().z() / cm;
                    ...
                    fHCZ_EdepSum[0][k] += fHCZ_Edep[0][index];
                    fHCZ_LOSum[0][k] += fHCZ_LO[0][index];
                    fHCZ_A1Sum[0][k] += fHCZ_A1[0][index];
                    fHCZ_A2Sum[0][k] += fHCZ_A2[0][index];
                    fHCZ_T1Sum[0][k] += fHCZ_T1[0][index];
                    fHCZ_T2Sum[0][k] += fHCZ_T2[0][index];
                    fHCZ_TrackLengthSum[0][k] += fHCZ_TrackLength[0][index];
                    fHCZ_ToFSum[0][k] += fHCZ_ToF[0][index];

                    fHCZ_NSum[0][0]++;
                    fHCZ_EdepSum[0][0] += fHCZ_Edep[0][index];
                    fHCZ_LOSum[0][0] += fHCZ_LO[0][index];
                    fHCZ_A1Sum[0][0] += fHCZ_A1[0][index];
                    fHCZ_A2Sum[0][0] += fHCZ_A2[0][index];
                    fHCZ_T1Sum[0][0] += fHCZ_T1[0][index];
                    fHCZ_T2Sum[0][0] += fHCZ_T2[0][index];
                    fHCZ_TrackLengthSum[0][0] += fHCZ_TrackLength[0][index];
                    fHCZ_ToFSum[0][0] += fHCZ_ToF[0][index];
            ...
            if (HadronCalorimeter_nsys2Hit_->GetEdep() > HadronCalorimeter_threshold) {
                ...
                if (index >= 0 && index < N_HCX) {
                    ...
                    if (index >= 1)
                    {
                     ...
                     if (index >= 1)
                     {
                         ...
                         fHCX_global_XPos[1][index] = HadronCalorimeter_nsys2Hit_->GetWorldPos().x() / cm;
                         fHCX_global_YPos[1][index] = HadronCalorimeter_nsys2Hit_->GetWorldPos().y() / cm;
                         fHCX_global_ZPos[1][index] = HadronCalorimeter_nsys2Hit_->GetWorldPos().z() / cm;
                    ...
                    ///
                    fHCX_NSum[1][k]++;
                    fHCX_EdepSum[1][k] += fHCX_Edep[1][index];
                    fHCX_LOSum[1][k] += fHCX_LO[1][index];
                    fHCX_A1Sum[1][k] += fHCX_A1[1][index];
                    fHCX_A2Sum[1][k] += fHCX_A2[1][index];
                    fHCX_T1Sum[1][k] += fHCX_T1[1][index];
                    fHCX_T2Sum[1][k] += fHCX_T2[1][index];
                    fHCX_TrackLengthSum[1][k] += fHCX_TrackLength[1][index];
                    fHCX_ToFSum[1][k] += fHCX_ToF[1][index];

                    fHCX_NSum[1][0]++;
                    fHCX_EdepSum[1][0] += fHCX_Edep[1][index];
                    fHCX_LOSum[1][0] += fHCX_LO[1][index];
                    fHCX_A1Sum[1][0] += fHCX_A1[1][index];
                    fHCX_A2Sum[1][0] += fHCX_A2[1][index];
                    fHCX_T1Sum[1][0] += fHCX_T1[1][index];
                    fHCX_T2Sum[1][0] += fHCX_T2[1][index];
                    fHCX_TrackLengthSum[1][0] += fHCX_TrackLength[1][index];
                    fHCX_ToFSum[1][0] += fHCX_ToF[1][index];
                ...
                if (index >= 0 && index < N_HCZ) {
                   ...
                   // k = 22 - k +1; // в эксперименте нумерация Z против пучка
                    ...
                    if (index >= 1)
                    {
                        fHCZ_Edep[1][index] = HadronCalorimeter_nsys2Hit_->GetEdep() / MeV;
                        ...
                        fHCZ_global_XPos[1][index] = HadronCalorimeter_nsys2Hit_->GetWorldPos().x() / cm;
                        fHCZ_global_YPos[1][index] = HadronCalorimeter_nsys2Hit_->GetWorldPos().y() / cm;
                        fHCZ_global_ZPos[1][index] = HadronCalorimeter_nsys2Hit_->GetWorldPos().z() / cm;
                    ...
                    fHCZ_NSum[1][k]++;
                    fHCZ_EdepSum[1][k] += fHCZ_Edep[1][index];
                    fHCZ_LOSum[1][k] += fHCZ_LO[1][index];
                    fHCZ_A1Sum[1][k] += fHCZ_A1[1][index];
                    fHCZ_A2Sum[1][k] += fHCZ_A2[1][index];
                    fHCZ_T1Sum[1][k] += fHCZ_T1[1][index];
                    fHCZ_T2Sum[1][k] += fHCZ_T2[1][index];
                    fHCZ_TrackLengthSum[1][k] += fHCZ_TrackLength[1][index];
                    fHCZ_ToFSum[1][k] += fHCZ_ToF[1][index];

                    fHCZ_NSum[1][0]++;
                    fHCZ_EdepSum[1][0] += fHCZ_Edep[1][index];
                    fHCZ_LOSum[1][0] += fHCZ_LO[1][index];
                    fHCZ_A1Sum[1][0] += fHCZ_A1[1][index];
                    fHCZ_A2Sum[1][0] += fHCZ_A2[1][index];
                    fHCZ_T1Sum[1][0] += fHCZ_T1[1][index];
                    fHCZ_T2Sum[1][0] += fHCZ_T2[1][index];
                    fHCZ_TrackLengthSum[1][0] += fHCZ_TrackLength[1][index];
                    fHCZ_ToFSum[1][0] += fHCZ_ToF[1][index];
