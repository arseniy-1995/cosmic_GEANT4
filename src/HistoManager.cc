...
namespace Cosmic
{
    ...
    HistoManager::HistoManager(EventAction *eventAction) : fFileName("Cosmic"), fEventAction(eventAction) { Book(); }
    ...
    void HistoManager::Book()
    {
        ...
        if (fEventAction)
        {
            ...
            //  analysisManager->CreateNtupleDColumn(fCurrentNtupleId,"XVertex"); // column Id = 5  // Позиция вершины
            //  (точка генерации) analysisManager->CreateNtupleDColumn(fCurrentNtupleId,"YVertex"); // column Id = 6
            //  analysisManager->CreateNtupleDColumn(fCurrentNtupleId,"ZVertex"); // column Id = 7

            //  analysisManager->CreateNtupleIColumn(fCurrentNtupleId,"IndexVertex"); // column Id = 8 // Индекс частицы
            //  по PDG analysisManager->CreateNtupleIColumn(fCurrentNtupleId,"MassVertex"); // column Id = 9 // Индекс
            //  частицы по PDG
            //   analysisManager->CreateNtupleDColumn(fCurrentNtupleId,"EnergyVertex"); // column Id = 10 //
            ...
            //  analysisManager->CreateNtupleFColumn(fCurrentNtupleId,"Eplastic_fat_nsys1_vector",
            //  fEventAction->GetPlasticEdep()); // column Id = 4
            ...
            analysisManager->CreateNtupleIColumn(fCurrentNtupleId, "TrackIDplastic_fat_nsys1",
                                                 fEventAction->GetTrackIDPlasticFat(1));

            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "Eplastic_fat_nsys1",
                fEventAction->GetPlasticFatEdep(1)); // column Id = 4 // Энерговыделение
            ...
            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "A1plastic_fat_nsys1",
                fEventAction->GetPlasticFatA1(1)); // column Id = 8 // Амплутуды с противоположных торцов

            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "A2plastic_fat_nsys1",
                                                 fEventAction->GetPlasticFatA2(1)); // column Id = 10 //


            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "T1plastic_fat_nsys1",
                                                 fEventAction->GetPlasticFatT1(1));
            // column Id = 8 // Времена с противоположных торцов
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "T2plastic_fat_nsys1",
                                                 fEventAction->GetPlasticFatT2(1));
            // column Id = 10 //

            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Lplastic_fat_nsys1",
                                                 fEventAction->GetPlasticFatTrackLength(1));
            // column Id = 8 // Длина пробега


            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "ToFplastic_fat_nsys1",
                                                 fEventAction->GetPlasticFatToF(1));
            // column Id = 10 // TimeOfFlight


            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Xplastic_fat_nsys1",
                                                 fEventAction->GetPlasticFatPos(1,
            ...
            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "Xglob_plastic_fat_nsys1",
                fEventAction->GetPlasticFatGlobalPos(1,
            ...
            analysisManager->CreateNtupleIColumn(fCurrentNtupleId, "TrackIDplastic_fat_nsys2",
                                                 fEventAction->GetTrackIDPlasticFat(2));
            ...
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Lplastic_fat_nsys2",
                                                 fEventAction->GetPlasticFatTrackLength(2));
            // column Id = 9
            ...
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "T1plastic_fat_nsys2",
                                                 fEventAction->GetPlasticFatT1(2));
            // column Id = 9
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "T2plastic_fat_nsys2",
                                                 fEventAction->GetPlasticFatT2(2));
            // column Id = 11
            ...
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Xplastic_fat_nsys2",
                                                 fEventAction->GetPlasticFatPos(2,
                                                                                1)); // column Id = 4 // Локальная точка
            ...
            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "Xglob_plastic_fat_nsys2",
                fEventAction->GetPlasticFatGlobalPos(2,
                                                     1)); // column Id = 4 // Глобальная точка
            ...
            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "Thetaplastic_fat_nsys2",
                fEventAction->GetPlasticFatAngle(2,
                                                 1)); // column Id = 4 // Локальная точка
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Phiplastic_fat_nsys2",
                                                 fEventAction->GetPlasticFatAngle(2, 2)); // column Id = 4 //

            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "ThetaGlobplastic_fat_nsys2",
                fEventAction->GetPlasticFatAngleGlob(2,
                                                     1)); // column Id = 4 // Локальная точка
            ...
            // nsys1
            //  X-bars
            analysisManager->CreateNtupleIColumn(fCurrentNtupleId, "TrackID_HCX_nsys1",
                                                 fEventAction->Get_HCX_TrackID(1));
            ...
            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "A1_HCX_nsys1",
                fEventAction->Get_HCX_A1(1)); // column Id = 8 // Амплутуды с противоположных торцов
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "A2_HCX_nsys1",
                                                 fEventAction->Get_HCX_A2(1)); // column Id = 10 //

            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "T1_HCX_nsys1",
                fEventAction->Get_HCX_T1(1)); // column Id = 8 // Времена с противоположных торцов
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "T2_HCX_nsys1",
                                                 fEventAction->Get_HCX_T2(1)); // column Id = 10 //

            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "L_HCX_nsys1",
            ...
            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "A1Sum_HCX_nsys1",
                fEventAction->Get_HCX_A1Sum(1)); // column Id = 8 // Амплутуды с противоположных торцов
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "A2Sum_HCX_nsys1", fEventAction->Get_HCX_A2Sum(1));
            // column Id = 10 //

            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "T1Sum_HCX_nsys1",
                fEventAction->Get_HCX_T1Sum(1)); // column Id = 8 // Времена с противоположных торцов
            ...
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Y_HCX_nsys1",
                                                 fEventAction->Get_HCX_Pos(1, 2)); // column Id = 4 //
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Z_HCX_nsys1",
                                                 fEventAction->Get_HCX_Pos(1, 3)); // column Id = 4 //

            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Xglob_HCX_nsys1",
                                                 fEventAction->Get_HCX_GlobalPos(1, 1));
            // column Id = 4 // Глобальная точка
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Yglob_HCX_nsys1",
                                                 fEventAction->Get_HCX_GlobalPos(1, 2));
            // column Id = 4 //
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Zglob_HCX_nsys1",
                                                 fEventAction->Get_HCX_GlobalPos(1, 3));
            // column Id = 4 //


            // Z-bars
            analysisManager->CreateNtupleIColumn(fCurrentNtupleId, "TrackID_HCZ_nsys1",
                                                 fEventAction->Get_HCZ_TrackID(1));
            ...
            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "A1_HCZ_nsys1",
                fEventAction->Get_HCZ_A1(1)); // column Id = 8 // Амплутуды с противоположных торцов
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "A2_HCZ_nsys1",
                                                 fEventAction->Get_HCZ_A2(1)); // column Id = 10 //

            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "T1_HCZ_nsys1",
                fEventAction->Get_HCZ_T1(1)); // column Id = 8 // Времена с противоположных торцов
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "T2_HCZ_nsys1",
                                                 fEventAction->Get_HCZ_T2(1)); // column Id = 10 //

            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "L_HCZ_nsys1",
            ...
            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "A1Sum_HCZ_nsys1",
                fEventAction->Get_HCZ_A1Sum(1)); // column Id = 8 // Амплутуды с противоположных торцов
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "A2Sum_HCZ_nsys1", fEventAction->Get_HCZ_A2Sum(1));
            // column Id = 10 //

            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "T1Sum_HCZ_nsys1",
                fEventAction->Get_HCZ_T1Sum(1)); // column Id = 8 // Времена с противоположных торцов
            ...
            // column Id = 4 // Локальная точка
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Y_HCZ_nsys1",
                                                 fEventAction->Get_HCZ_Pos(1, 2)); // column Id = 4 //
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Z_HCZ_nsys1",
                                                 fEventAction->Get_HCZ_Pos(1, 3)); // column Id = 4 //

            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Xglob_HCZ_nsys1",
                                                 fEventAction->Get_HCZ_GlobalPos(1, 1));
            // column Id = 4 // Глобальная точка
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Yglob_HCZ_nsys1",
                                                 fEventAction->Get_HCZ_GlobalPos(1, 2));
            // column Id = 4 //
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Zglob_HCZ_nsys1",
                                                 fEventAction->Get_HCZ_GlobalPos(1, 3));
            // column Id = 4 //
            ...
            // X-bars
            analysisManager->CreateNtupleIColumn(fCurrentNtupleId, "TrackID_HCX_nsys2",
                                                 fEventAction->Get_HCX_TrackID(2));
            ...
            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "A1_HCX_nsys2",
                fEventAction->Get_HCX_A1(2)); // column Id = 8 // Амплутуды с противоположных торцов
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "A2_HCX_nsys2",
                                                 fEventAction->Get_HCX_A2(2)); // column Id = 10 //

            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "T1_HCX_nsys2",
                fEventAction->Get_HCX_T1(2)); // column Id = 8 // Времена с противоположных торцов
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "T2_HCX_nsys2",
                                                 fEventAction->Get_HCX_T2(2)); // column Id = 10 //

            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "L_HCX_nsys2", fEventAction->Get_HCX_TrackLength(2));
            // column Id = 8 // Длина пробега
            ...
            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "A1Sum_HCX_nsys2",
                fEventAction->Get_HCX_A1Sum(2)); // column Id = 8 // Амплутуды с противоположных торцов
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "A2Sum_HCX_nsys2", fEventAction->Get_HCX_A2Sum(2));
            // column Id = 10 //

            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "T1Sum_HCX_nsys2",
                fEventAction->Get_HCX_T1Sum(2)); // column Id = 8 // Времена с противоположных торцов
            ...
            // column Id = 4 // Локальная точка
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Y_HCX_nsys2",
                                                 fEventAction->Get_HCX_Pos(2, 2)); // column Id = 4 //
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Z_HCX_nsys2",
                                                 fEventAction->Get_HCX_Pos(2, 3)); // column Id = 4 //


            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Xglob_HCX_nsys2",
                                                 fEventAction->Get_HCX_GlobalPos(2, 1));
            // column Id = 4 // Глобальная точка
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Yglob_HCX_nsys2",
                                                 fEventAction->Get_HCX_GlobalPos(2, 2));
            // column Id = 4 //
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Zglob_HCX_nsys2",
                                                 fEventAction->Get_HCX_GlobalPos(2, 3));
            // column Id = 4 //


            // Z-bars

            analysisManager->CreateNtupleIColumn(fCurrentNtupleId, "TrackID_HCZ_nsys2",
                                                 fEventAction->Get_HCZ_TrackID(2));
            ...
            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "A1_HCZ_nsys2",
                fEventAction->Get_HCZ_A1(2)); // column Id = 8 // Амплутуды с противоположных торцов
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "A2_HCZ_nsys2",
                                                 fEventAction->Get_HCZ_A2(2)); // column Id = 10 //

            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "T1_HCZ_nsys2",
                fEventAction->Get_HCZ_T1(2)); // column Id = 8 // Времена с противоположных торцов
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "T2_HCZ_nsys2",
                                                 fEventAction->Get_HCZ_T2(2)); // column Id = 10 //

            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "L_HCZ_nsys2", fEventAction->Get_HCZ_TrackLength(2));
            // column Id = 8 // Длина пробега
            ...
            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "A1Sum_HCZ_nsys2",
                fEventAction->Get_HCZ_A1Sum(2)); // column Id = 8 // Амплутуды с противоположных торцов
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "A2Sum_HCZ_nsys2", fEventAction->Get_HCZ_A2Sum(2));
            // column Id = 10 //

            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "T1Sum_HCZ_nsys2",
                fEventAction->Get_HCZ_T1Sum(2)); // column Id = 8 // Времена с противоположных торцов
            ...
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "X_HCZ_nsys2",
                                                 fEventAction->Get_HCZ_Pos(2, 1)); // column Id = 4 // Локальная точка
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Y_HCZ_nsys2",
                                                 fEventAction->Get_HCZ_Pos(2, 2)); // column Id = 4 //
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Z_HCZ_nsys2",
                                                 fEventAction->Get_HCZ_Pos(2, 3)); // column Id = 4 //

            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Xglob_HCZ_nsys2",
                                                 fEventAction->Get_HCZ_GlobalPos(2, 1));
            // column Id = 4 // Глобальная точка
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Yglob_HCZ_nsys2",
                                                 fEventAction->Get_HCZ_GlobalPos(2, 2));
            // column Id = 4 //
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Zglob_HCZ_nsys2",
                                                 fEventAction->Get_HCZ_GlobalPos(2, 3)); // column Id = 4 //
            ...
            analysisManager->CreateNtupleIColumn(fCurrentNtupleId, "TrackIDplastic_thin_nsys1",
                                                 fEventAction->GetTrackIDPlasticThin(1));
            analysisManager->CreateNtupleIColumn(fCurrentNtupleId, "TrackIDplastic_thin_nsys2",
                                                 fEventAction->GetTrackIDPlasticThin(2));
            ...
            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "A1plastic_thin_nsys1",
                fEventAction->GetPlasticThinA1(1)); // column Id = 8 // Амплутуды с противоположных торцов
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "A1plastic_thin_nsys2",
                                                 fEventAction->GetPlasticThinA1(2)); // column Id = 9

            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "T1plastic_thin_nsys1",
                fEventAction->GetPlasticThinT1(1)); // column Id = 8 // Времена с противоположных торцов
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "T1plastic_thin_nsys2",
                                                 fEventAction->GetPlasticThinT1(2)); // column Id = 9
            ...
            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "Xplastic_thin_nsys1",
                fEventAction->GetPlasticThinPos(1,
                                                1)); // column Id = 4 // Локальная точка
            ...
            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "Xplastic_thin_nsys2",
                fEventAction->GetPlasticThinPos(2,
                                                1)); // column Id = 4 // Локальная точка
            ...
            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "Xglob_plastic_thin_nsys1",
                fEventAction->GetPlasticThinGlobalPos(1,
                                                      1)); // column Id = 4 // Глобальная точка
            ...
            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "Xglob_plastic_thin_nsys2",
                fEventAction->GetPlasticThinGlobalPos(2,
                                                      1)); // column Id = 4 // Глобальная точка
            ...
            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "Thetaplastic_thin_nsys2",
                fEventAction->GetPlasticThinAngle(2,
                                                  1)); // column Id = 4 // Локальная точка
            ...
            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "ThetaGlobplastic_thin_nsys2",
                fEventAction->GetPlasticThinAngleGlob(2,
                                                      1)); // column Id = 4 // Локальная точка
            ...
            analysisManager->CreateNtupleIColumn(fCurrentNtupleId, "TrackIDplastic_LQ_nsys1",
                                                 fEventAction->GetTrackIDPlasticLQ(2));
            analysisManager->CreateNtupleIColumn(fCurrentNtupleId, "TrackIDplastic_LQ_nsys2",
                                                 fEventAction->GetTrackIDPlasticLQ(1));
            ...
            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "A1plastic_LQ_nsys1",
                fEventAction->GetPlasticLQA1(2)); // column Id = 8 // Амплутуды с противоположных торцов
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "A2plastic_LQ_nsys1",
                                                 fEventAction->GetPlasticLQA2(2));
            // column Id = 9
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "A1plastic_LQ_nsys2",
                                                 fEventAction->GetPlasticLQA1(1));
            // column Id = 9
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "A2plastic_LQ_nsys2",
                                                 fEventAction->GetPlasticLQA2(1));

            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "T1plastic_LQ_nsys1",
                                                 fEventAction->GetPlasticLQT1(2));
            // column Id = 8 // Времена с противоположных торцов
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "T2plastic_LQ_nsys1",
                                                 fEventAction->GetPlasticLQT2(2));
            // column Id = 9
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "T1plastic_LQ_nsys2",
                                                 fEventAction->GetPlasticLQT1(1));
            // column Id = 9
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "T2plastic_LQ_nsys2",
                                                 fEventAction->GetPlasticLQT2(1));
            // column Id = 9
            ...
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Xplastic_LQ_nsys1",
                                                 fEventAction->GetPlasticLQPos(2,
                                                                               1)); // column Id = 4 // Локальная точка
            ...
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Xplastic_LQ_nsys2",
                                                 fEventAction->GetPlasticLQPos(1,
                                                                               1)); // column Id = 4 // Локальная точка
            ...
            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "Xglob_plastic_LQ_nsys1",
                fEventAction->GetPlasticLQGlobalPos(2,
                                                    1)); // column Id = 4 // Локальная точка
            ...
            analysisManager->CreateNtupleFColumn(
                fCurrentNtupleId, "Xglob_plastic_LQ_nsys2",
                fEventAction->GetPlasticLQGlobalPos(1,
                                                    1)); // column Id = 4 // Локальная точка
            ...
            analysisManager->CreateNtupleIColumn(fCurrentNtupleId, "TrackIDwa_nsys1",
                                                 fEventAction->Get_W_TrackID(1, 1));
            ...
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Xglobwa_nsys1",
                                                 fEventAction->Get_W_GlobalPos(1, 1, 1));
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Yglobwa_nsys1",
                                                 fEventAction->Get_W_GlobalPos(1, 2, 1));
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Zglobwa_nsys1",
                                                 fEventAction->Get_W_GlobalPos(1, 3, 1));


            // Камера B
            analysisManager->CreateNtupleIColumn(fCurrentNtupleId, "TrackIDwb_nsys1",
                                                 fEventAction->Get_W_TrackID(1, 2));
            ...
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Xglobwb_nsys1",
                                                 fEventAction->Get_W_GlobalPos(1, 1, 2));
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Yglobwb_nsys1",
                                                 fEventAction->Get_W_GlobalPos(1, 2, 2));
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Zglobwb_nsys1",
                                                 fEventAction->Get_W_GlobalPos(1, 3, 2));


            // Камера C

            analysisManager->CreateNtupleIColumn(fCurrentNtupleId, "TrackIDwc_nsys1",
                                                 fEventAction->Get_W_TrackID(1, 3));
            ...
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Xglobwc_nsys1",
                                                 fEventAction->Get_W_GlobalPos(1, 1, 3));
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Yglobwc_nsys1",
                                                 fEventAction->Get_W_GlobalPos(1, 2, 3));
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Zglobwc_nsys1",
                                                 fEventAction->Get_W_GlobalPos(1, 3, 3));
            ...
            analysisManager->CreateNtupleIColumn(fCurrentNtupleId, "TrackIDwa_nsys2",
                                                 fEventAction->Get_W_TrackID(2, 1));
            ...
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Xglobwa_nsys2",
                                                 fEventAction->Get_W_GlobalPos(2, 1, 1));
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Yglobwa_nsys2",
                                                 fEventAction->Get_W_GlobalPos(2, 2, 1));
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Zglobwa_nsys2",
                                                 fEventAction->Get_W_GlobalPos(2, 3, 1));


            // Камера B

            analysisManager->CreateNtupleIColumn(fCurrentNtupleId, "TrackIDwb_nsys2",
                                                 fEventAction->Get_W_TrackID(2, 2));
            ...
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Xglobwb_nsys2",
                                                 fEventAction->Get_W_GlobalPos(2, 1, 2));
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Yglobwb_nsys2",
                                                 fEventAction->Get_W_GlobalPos(2, 2, 2));
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Zglobwb_nsys2",
                                                 fEventAction->Get_W_GlobalPos(2, 3, 2));


            // Камера C

            analysisManager->CreateNtupleIColumn(fCurrentNtupleId, "TrackIDwc_nsys2",
                                                 fEventAction->Get_W_TrackID(2, 3));
            ...
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Xglobwc_nsys2",
                                                 fEventAction->Get_W_GlobalPos(2, 1, 3));
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Yglobwc_nsys2",
                                                 fEventAction->Get_W_GlobalPos(2, 2, 3));
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Zglobwc_nsys2",
                                                 fEventAction->Get_W_GlobalPos(2, 3, 3));
            ...
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Energyvc_nsys1",
                                                 fEventAction->Get_VC_KineticEnergy(1));
            ...
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Xglobvc_nsys1",
                                                 fEventAction->Get_VC_GlobalPos(1, 1));
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Yglobvc_nsys1",
                                                 fEventAction->Get_VC_GlobalPos(1, 2));
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Zglobvc_nsys1",
                                                 fEventAction->Get_VC_GlobalPos(1, 3));
            ...
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Energyvc_nsys2",
                                                 fEventAction->Get_VC_KineticEnergy(2));
            ...
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Xglobvc_nsys2",
                                                 fEventAction->Get_VC_GlobalPos(2, 1));
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Yglobvc_nsys2",
                                                 fEventAction->Get_VC_GlobalPos(2, 2));
            analysisManager->CreateNtupleFColumn(fCurrentNtupleId, "Zglobvc_nsys2",
                                                 fEventAction->Get_VC_GlobalPos(2, 3));
