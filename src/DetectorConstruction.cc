...
//////////////////////////////////////////////////////////////////////
    ...
    new G4PVPlacement(0,G4ThreeVector(x_pos_mag,0.,z_pos_mag),logicMag1,"Mag1",worldLV,false,-1, fCheckOverlaps);
    new G4PVPlacement(0,G4ThreeVector(-x_pos_mag,0.,z_pos_mag),logicMag1, "Mag1",worldLV,false,-1, fCheckOverlaps);

    G4Box* solidMag1a = new G4Box("Mag1a",x_size_mag/2.+d_z_mag,(y_size_mag/2.-d_y1_mag)/2.,z_size_mag/2.+d_z_mag);
