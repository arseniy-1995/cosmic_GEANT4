...
//
//
/// \file HadronCalorimeterHit.cc
/// \brief Implementation of the Cosmic::HadronCalorimeterHit class
...
namespace Cosmic {
    ...
    G4ThreadLocal G4Allocator<HadronCalorimeterHit> *HadronCalorimeterHitAllocator = nullptr;
    //   G4ThreadLocal G4Allocator<HadronCalorimeterHit>* HadronCalorimeterHitAllocator;


//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

    HadronCalorimeterHit::HadronCalorimeterHit() {
    ...
    HadronCalorimeterHit::HadronCalorimeterHit(G4int layerxID, G4int layeryID,G4int layerzID)
            : fLayerxID(layerxID), fLayeryID(layeryID), fLayerzID(layerzID) {}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
/*
    HadronCalorimeterHit::HadronCalorimeterHit(G4double l, G4double a, G4double thr, G4ThreeVector vp, const G4RotationMatrix *rr):
...
/*
    HadronCalorimeterHit::HadronCalorimeterHit(G4ThreeVector vp,const G4RotationMatrix *rr):
...
//const HadronCalorimeterHit &HadronCalorimeterHit::operator=(const HadronCalorimeterHit &right) {
//        fEdep = right.fEdep;
//        fTrackLength = right.fTrackLength;
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
    ...
    G4bool HadronCalorimeterHit::operator==(const HadronCalorimeterHit &right) const {
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
    ...
    const std::map<G4String, G4AttDef> *HadronCalorimeterHit::GetAttDefs() const {
        G4bool isNew;
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
    ...
    std::vector<G4AttValue> *HadronCalorimeterHit::CreateAttValues() const {
        auto values = new std::vector<G4AttValue>;

        values
                ->push_back(G4AttValue("HitType", "EmCalorimeterHit", ""));
        values
                ->push_back(G4AttValue("ID", G4UIcommand::ConvertToString(fLayeryID), ""));
        values
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
    ...
    void HadronCalorimeterHit::Print() {
        G4cout
                << "Edep: "
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
    ...
    void HadronCalorimeterHit::CalcRho(G4ThreeVector pos) {
    ...
    void HadronCalorimeterHit::AddLocalPos(G4ThreeVector pos) {
        fLocalPos = pos;
        CalcRho(pos);
    }
    ...
    //....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
       ...
       void HadronCalorimeterHit::AddLO(G4double de, G4ThreeVector pos, G4ThreeVector delta, G4double velocity, G4double ToF)  {
        G4double dlo = 0.;
